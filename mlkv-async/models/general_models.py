...
from .pytorch.mlkv_models import MLKVEmbedding
...
class KEModel(object):
    ...
    def __init__(self, args, model_name, n_entities, n_relations, hidden_dim, gamma,
        ...
        self.entity_emb = MLKVEmbedding(args, n_entities, entity_dim,
    ...
    def writeback_relation(self, rank=0, rel_parts=None):
        ...
        self.global_relation_emb.emb[idx] = self.relation_emb(th.from_numpy(idx), -1, False)
        if self.model_name == 'TransR':
